...
class Setup_allowances extends CI_Controller
{
    ...
    public function readUnregistered()
    {
        ...
        $this->db->join('setup_allowances b', 'a.id = b.employee_id', 'left');
    ...
    public function datatables()
    {
        if ($this->input->post()) {
            ...
            $result = array();
            //Select Query
            $this->db->select('a.*, b.name as allowance_name, c.id as employee_id, c.number as employee_number, c.name as employee_name, d.name as division_name, e.name as departement_name, f.name as departement_sub_name');
