...

    {
        ...
        if ($this->input->post()) {
            ...
            $this->db->select('a.*, 
                ...
                i.name as departement_sub_name,
            ...
            $this->db->join('departement_subs i', 'a.departement_sub_id = i.id', 'left');
...

    {
        ...
        if ($this->input->post()) {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $approvals = $this->crud->read('approvals', [], ["table_name" => $post['table_name'], "departement_id" => $post['departement_id'], "departement_sub_id" => $post['departement_sub_id']]);
