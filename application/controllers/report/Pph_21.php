...

{
...

    {
        ...
        // Tambahkan entry khusus untuk HARIAN LEPAS
        $send[] = array('id' => 'HARIAN LEPAS', 'name' => 'HARIAN LEPAS');
...

    {
        ...
        if ($this->input->get()) {
            ...
            // Query untuk karyawan harian lepas
            $query_daily = $this->db->query("SELECT b.name, b.tax_id, b.national_id, b.address, a.attandance_wd, a.marital, a.income
...

    {
        ...
        if ($this->input->get()) {
            ...
            // Query untuk karyawan harian lepas
            $query_daily = $this->db->query("SELECT a.number, b.name, b.tax_id, b.national_id, c.name as alamat, a.attandance_wd, a.marital, a.net_income, d.name as group_name
                FROM payroll_harian_lepas a
                JOIN employees b ON a.employee_id = b.id
                JOIN groups d ON b.group_id = d.id and d.ppt = 1
                LEFT JOIN sources c ON b.source_id = c.id
