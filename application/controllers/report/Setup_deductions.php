...
class Setup_deductions extends CI_Controller
{
    ...
    public function index()
    {
        if (empty($this->session->username)) {
            ...
            $this->load->view('report/setup_deductions');
        } else {
    ...
    public function print($option = "")
    {
        ...
        if ($this->input->get()) {
            ...
            if ($filter_status == "DEDUCTION") {
                $this->db->where("a.deduction_id != ''");
            } elseif ($filter_status == "NO DEDUCTION") {
                $this->db->where("a.deduction_id is null");
            }
            ...
            <center>
                <h3 style="margin:0;">Report Setup Deduction</h3>
            </center>
            <br>
