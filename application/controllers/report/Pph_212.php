...

{
...

    {
        ...
        if ($this->input->get()) {
            ...
            $query_regular = $this->db->query("SELECT b.name, b.tax_id, b.national_id, b.address, a.attandance_wd, a.marital, a.pph, a.income
                FROM payrolls a
            ...
            // Query untuk payroll harian lepas
            $query_harian_lepas = $this->db->query("SELECT b.name, b.tax_id, b.national_id, b.address, a.attandance_wd, a.marital, a.pph, a.income
            ...
            $records_regular = $query_regular->result_array();
            $records_harian_lepas = $query_harian_lepas->result_array();
            $records = array_merge($records_regular, $records_harian_lepas);
