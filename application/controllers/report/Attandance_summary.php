        ...
        if ($this->input->get()) {
            ...
            <table id="customers" border="1">
                ...
                $this->db->join(
                    ...
                    "a.permit_type_id = b.id and a.permit_date >= '$filter_from' and a.permit_date <= '$filter_to' and a.employee_id LIKE '%$filter_employee%' and a.departement_id = '$record[departement_id]' and a.departement_sub_id LIKE '%$record[departement_sub_id]%' and a.group_id LIKE '%$filter_group%'",
                    'left'
                );
                ...
                and a.permit_date BETWEEN '$filter_from' and '$filter_to' and a.employee_id LIKE '%$filter_employee%' and b.departement_id LIKE '%$record[departement_id]%' and b.departement_sub_id LIKE '%$record[departement_sub_id]%' and b.group_id LIKE '%$filter_group%'
