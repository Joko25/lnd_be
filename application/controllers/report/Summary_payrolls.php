        ...
        if ($this->input->get()) {
            ...
            $html .= '  <table id="customers" border="1">
                        <tr>
                            ...
                            <th style="text-align:center;">Correction Plus</th>
                            <th style="text-align:center;">Total Income</th>
                            <th style="text-align:center;">Deduction</th>
                            <th style="text-align:center;">Correction Minus</th>
                            <th style="text-align:center;">Total Reduction</th>
                            <th style="text-align:center;">PPH21</th>
                            <th style="text-align:center;">Nett Income</th>
                        </tr>';
            $no = 1;
            foreach ($records as $record) {
                ...
                $html .= '<tr>
                            ...
                            <td>' . $record['name'] . '</td>
                            <td style="text-align:left;">' . $record['bank_no'] . '</td>
                            ...
                            <td style="text-align:right;">' . number_format(($record['salary'] + $total_allowence + $record['correction_plus']), 0, ",", ".") . '</td>
                            ...
                            <td style="text-align:right;">' . number_format(($total_deduction + $record['correction_minus']), 0, ",", ".") . '</td>
