...

    {
        ...
        if ($this->input->get()) {
            ...
            $query = $this->db->query("SELECT a.*, 
                ...
                JOIN (
                    SELECT employee_id, bpjs_company, bpjs_employee, period_start FROM payrolls WHERE period_start = '$period_start'
                    UNION ALL
                    SELECT employee_id, bpjs_company, bpjs_employee, period_start FROM payroll_harian_lepas WHERE period_start = '$period_start'
