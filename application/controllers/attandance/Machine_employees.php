...
class Machine_employees extends CI_Controller
{
    ...
    public function index()
    {
        if (empty($this->session->username)) {
            ...
            $this->load->view('attandance/machine_employees');
        } else {
    ...
    public function datatables()
    {
        if ($this->input->post()) {
            ...
            $result = array();
            //Select Query
            $this->db->select('id, number, name, machine_code, created_by, created_date, updated_by, updated_date');
    ...
    public function print($option = "")
    {
        ...
        $this->db->select('id, number, name, machine_code');
        $this->db->from('employees');
        $this->db->where('deleted', 0);
        $this->db->where('status', 0);
        $this->db->like('id', $filter_employee);
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="font-size: 14px; text-align: left; margin:2px;">
                            <b>' . $config->name . '</b><br>
                            <small>DATA MACHINE ATTANDANCE EMPLOYEE</small>
                        </td>
                    </tr>
                </table>
            </div>
