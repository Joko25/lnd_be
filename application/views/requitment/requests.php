...
<div id="dlg_insert" class="easyui-dialog" title="Add New" 
     data-options="closed: true,modal:true" 
     style="width: 800px; padding:10px; top: 20px;">

    <form id="frm_insert" method="post" novalidate>
        <fieldset style="width:100%; border:1px solid #d0d0d0; 
                         margin-bottom: 10px; border-radius:4px;">
            <legend><b>Form New Request</b></legend>
            ...
            <div style="display: flex; flex-wrap: wrap; gap: 10px;">
                ...
                <div style="flex: 1; min-width: 350px;">
                    <div class="fitem">
                        <span style="width:35%; display:inline-block;">Education</span>
                        <input style="width:60%;" name="education" required="true" class="easyui-textbox">
                    </div>

                    <div class="fitem">
                        <span style="width:35%; display:inline-block;">Experience</span>
                        <input style="width:60%;" name="experience" required="true" class="easyui-textbox">
                    </div>

                    <div class="fitem">
                        <span style="width:35%; display:inline-block;">Request</span>
                        <div style="width:60%; display:inline-block;">
                            <label>
                                <input type="radio" name="request" value="New Request" required> New Request
                            </label>
                            <label style="margin-left: 10px;">
                                <input type="radio" name="request" value="Replacement"> Replacement
                            </label>
                        </div>
                    </div>

                    <div class="fitem">
                        <span style="width:35%; display:inline-block;">Previous</span>
                        <input style="width:60%;" name="previous" id="previous" required="true" class="easyui-combobox">
                    </div>

                    <div class="fitem">
                        <span style="width:35%; display:inline-block;">Candidate Sources</span>
                        <div style="width:60%; display:inline-block;">
                            <label>
                                <input type="radio" name="candidate_sources" value="Internal" required> Internal
                            </label>
                            <label style="margin-left: 10px;">
                                <input type="radio" name="candidate_sources" value="External"> External
                            </label>
                        </div>
                    </div>
...
<script>
    ...
    $(function() {
        ...
        // Previous combobox configuration
        $('#previous').combobox({
            data: [
                {value: 'Vacant Position', text: 'Vacant Position'},
                {value: 'Termination', text: 'Termination'},
                {value: 'Resign', text: 'Resign'},
                {value: 'Mutation', text: 'Mutation'},
                {value: 'Promotion', text: 'Promotion'},
                {value: 'Demotion', text: 'Demotion'}
            ],
            valueField: 'value',
            textField: 'text',
            prompt: 'Choose Previous Status',
            panelHeight: 'auto'
        });

        // Position combobox configuration
