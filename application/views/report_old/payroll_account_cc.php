...
<script>
    ...
    function filter() {
        ...
        if (filter_month_start == "" || filter_month_end == "") {
            ...
            $("#printout").attr('src', '<?= base_url('report/payroll_account_cc/print') ?>' + url);
        }
    }
    ...
    function excel() {
        ...
        if (filter_month_start == "" || filter_month_end == "") {
            ...
            window.location.assign('<?= base_url('report/payroll_account_cc/print/excel') ?>' + url);
        }
    }

    $(function() {
        $('#filter_month_start').combobox({
            url: '<?php echo base_url('report/payroll_account_cc/readMonths'); ?>',
            valueField: 'id',
            textField: 'name',
            prompt: 'Select Month',
        });
        ...
        $('#filter_year_start').combobox({
            url: '<?php echo base_url('report/payroll_account_cc/readYears'); ?>',
            valueField: 'id',
            textField: 'name',
            prompt: 'Select Year',
        });
