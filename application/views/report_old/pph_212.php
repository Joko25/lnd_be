...
<script>
    ...
    function filter() {
        ...
        if (filter_from == "" || filter_to == "") {
            ...
            $("#printout").attr('src', '<?= base_url('report/pph_212/print') ?>' + url);
        }
    }
    ...
    function excel() {
        ...
        if (filter_from == "" || filter_to == "") {
            ...
            window.location.assign('<?= base_url('report/pph_212/print/excel') ?>' + url);
        }
    }
    ...
    function csv() {
        ...
        if (filter_from == "" || filter_to == "") {
            ...
            window.open('<?= base_url('report/pph_212/csv') ?>' + url);
        }
    }
    ...
    $(function() {
        ...
        $('#filter_group').combobox({
            url: '<?= base_url('report/pph_212/groups') ?>',
            valueField: 'id',
            textField: 'name',
            prompt: "Choose All",
            icons: [{
