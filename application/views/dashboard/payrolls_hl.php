...
<script>
    function filter(){
        ...
        $.ajax({
            type: "post",
            url: "<?= base_url("dashboard/payrolls_hl/myPayroll?filter_from=") ?>" + btoa(filter_from) + "&filter_to=" + btoa(filter_to),
            dataType: "json",
        ...
        $('#dg_departement').datagrid({
            url: '<?= base_url('dashboard/payrolls_hl/tableDepartement?filter_from=') ?>' + btoa(filter_from) + "&filter_to=" + btoa(filter_to),
            rownumbers: true,
            pagination: false,
        });

        $('#dg_position').datagrid({
            url: '<?= base_url('dashboard/payrolls_hl/tablePosition?filter_from=') ?>' + btoa(filter_from) + "&filter_to=" + btoa(filter_to),
            rownumbers: true,
            pagination: false,
        });

        $('#dg_group').datagrid({
            url: '<?= base_url('dashboard/payrolls_hl/tableGroup?filter_from=') ?>' + btoa(filter_from) + "&filter_to=" + btoa(filter_to),
            rownumbers: true,
            pagination: false,
        });
        ...
        $.ajax({
            type: "post",
            url: "<?= base_url('dashboard/payrolls_hl/chartDepartement?filter_from=') ?>" + btoa(filter_from) + "&filter_to=" + btoa(filter_to),
            data: "period_start=",
            dataType: "json",
        ...
        $.ajax({
            type: "post",
            url: "<?= base_url('dashboard/payrolls_hl/chartPosition?filter_from=') ?>" + btoa(filter_from) + "&filter_to=" + btoa(filter_to),
            data: "period_start=",
            dataType: "json",
        ...
        $.ajax({
            type: "post",
            url: "<?= base_url('dashboard/payrolls_hl/chartGroup?filter_from=') ?>" + btoa(filter_from) + "&filter_to=" + btoa(filter_to),
            data: "period_start=",
            dataType: "json",
