...
<script>
    ...
    $(function() {
        ...
        $.ajax({
            ...
            url: "<?= base_url('dashboard/employees_hl/chartDepartement') ?>",
        ...
        $.ajax({
            ...
            url: "<?= base_url('dashboard/employees_hl/chartGroups') ?>",
        ...
        $.ajax({
            ...
            url: "<?= base_url("dashboard/employees_hl/chartService") ?>",
        ...
        $.ajax({
            ...
            url: "<?= base_url("dashboard/employees_hl/chartGender") ?>",
        ...
        $.ajax({
            ...
            url: "<?= base_url("dashboard/employees_hl/chartMarital") ?>",
        ...
        $.ajax({
            ...
            url: "<?= base_url("dashboard/employees_hl/chartDomicile") ?>",
        ...
        $.ajax({
            ...
            url: "<?= base_url("dashboard/employees_hl/chartEducation") ?>",
