...
<script>
    ...
    function add() {
        ...
        url_save = '<?= base_url('attandance/cash_carries_harian_lepas/create') ?>';
    ...
    function update() {
        ...
        if (row) {
            ...
            url_save = '<?= base_url('attandance/cash_carries_harian_lepas/update') ?>';
            ...
            $('#dg2').datagrid({
                ...
                url: '<?= base_url('attandance/cash_carries_harian_lepas/datatable_updates?request_code=') ?>' + window.btoa(row.request_code),
                ...
                [{
                    ...
                    editor: {
                        ...
                        options: {
                            ...
                            url: '<?= base_url('employee/employee_harian_lepas/reads?departement_id=') ?>' + departement_id,
                ...
                if (r) {
                    ...
                    for (var i = 0; i < rows.length; i++) {
                        ...
                        $.ajax({
                            ...
                            url: '<?= base_url('attandance/cash_carries_harian_lepas/delete') ?>',
    ...
    function filter() {
        ...
        $('#dg').datagrid({
            ...
            url: '<?= base_url('attandance/cash_carries_harian_lepas/datatables') ?>' + url
        ...
        $("#printout").attr('src', '<?= base_url('attandance/cash_carries_harian_lepas/print') ?>' + url);
    ...
    function excel() {
        ...
        window.location.assign('<?= base_url('attandance/cash_carries_harian_lepas/print/excel') ?>' + url);
    ...
    $(function() {
        ...
        $('#dg').datagrid({
            ...
            url: '<?= base_url('attandance/cash_carries_harian_lepas/datatables') ?>',
                ...
                handler: function() {
                    ...
                    if (idm_no != "" && request_code != "" && totalrows > 0) {
                        ...
                        $('#frm_insert').form('submit', {
                            ...
                            url: '<?= base_url('attandance/cash_carries_harian_lepas/uploadFile') ?>',
        ...
        $('#dlg_upload').dialog({
            ...
            buttons: [{
                ...
                handler: function() {
                    ...
                    window.open('<?= base_url('attandance/cash_carries_harian_lepas/uploadDownloadFailed') ?>', '_blank');
                ...
                handler: function() {
                    ...
                    $('#frm_upload').form('submit', {
                        ...
                        url: '<?= base_url('attandance/cash_carries_harian_lepas/upload') ?>',
                        ...
                        success: function(result) {
                            ...
                            $.ajax({
                                ...
                                url: "<?= base_url('attandance/cash_carries_harian_lepas/uploadclearFailed') ?>"
                            ...
                            function requestData(total, json, number = 1, value = 0, success = 1, failed = 1) {
                                ...
                                if (value < 100) {
                                    ...
                                    $.ajax({
                                        ...
                                        url: "<?= base_url('attandance/cash_carries_harian_lepas/uploadCreate') ?>",
                                        ...
                                        success: function(result) {
                                            ...
                                            if (result.theme == "success") {
                                                ...
                                                $.ajax({
                                                    ...
                                                    url: "<?= base_url('attandance/cash_carries_harian_lepas/uploadcreateFailed') ?>",
        ...
        $('#filter_request_code').combobox({
            ...
            url: '<?= base_url('attandance/cash_carries_harian_lepas/readRequestCode') ?>',
        ...
        $('#filter_idm').combobox({
            ...
            url: '<?= base_url('attandance/cash_carries_harian_lepas/readIdm') ?>',
                ...
                $('#departement_id').combobox({
                    ...
                    onSelect: function(dept) {
                        ...
                        $.ajax({
                            ...
                            url: '<?= base_url('attandance/cash_carries_harian_lepas/requestCode') ?>',
