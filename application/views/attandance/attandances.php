<!-- TABLE DATAGRID -->
<table id="dg" class="easyui-datagrid" style="width:100%; height: 770px;" toolbar="#toolbar" data-options="rownumbers:true, singleSelect:false, view: scrollview, idField:'date_in', autoRowHeight:false, pageSize:50">
    <thead>
        <tr>
