...
<div id="toolbar" style="height: 235px; padding:10px;">
    ...
    <fieldset style="width: 99%; border:2px solid #d0d0d0; margin-bottom: 5px; margin-top: 5px; border-radius:4px;">
        ...
        <div style="width: 50%; float:left;">
            <div class="fitem">
                <span style="width:35%; display:inline-block;">Years</span>
                <input style="width:30%;" name="filter_from" id="filter_year" class="easyui-combobox">
            </div>
            <div class="fitem">
...
<script>
    ...
    function filter() {
        ...
        if (filter_year == "") {
            ...
            $("#printout").attr('src', '<?= base_url('report/leaves/print') ?>' + url);
        }
    }
    ...
    function excel() {
        ...
        if (filter_year == "") {
            ...
            window.location.assign('<?= base_url('report/leaves/print/excel') ?>' + url);
        }
    }
    ...
    $(function() {
        ...
        $("#filter_year").combobox({
            url: '<?= base_url('report/leaves/readYears') ?>',
            valueField: 'year',
            textField: 'year',
            prompt: "Choose Years"
        });
