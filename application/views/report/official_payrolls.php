...
<div class="easyui-panel" title="Print Preview" style="width:100%;padding:10px;" data-options="fit:true">
    <iframe id="printout" src="" style="width: 100%; height:62%; border: 0;"></iframe>
</div>
<script>
    function reload() {
    ...
    function filter() {
        ...
        if (filter_from == "" || filter_to == "") {
            ...
            $("#printout").attr('src', '<?= base_url('report/official_payrolls/print') ?>' + url);
        }
    }
    ...
    function excel() {
        ...
        if (filter_from == "" || filter_to == "") {
            ...
            window.location.assign('<?= base_url('report/official_payrolls/print/excel') ?>' + url);
        }
    }
