        ...
        <fieldset style="width: 99%; border:2px solid #d0d0d0; margin-bottom: 5px; border-radius:4px;">
            ...
            <div style="width: 49%; float:left;">
                ...
                <div class="fitem">
                    ...
                    <input style="width:60%;" id="filter_source" class="easyui-combobox">
...
<script>
    ...
    function filter() {
        ...
        if (Difference_In_Days <= 31) {
            ...
            if ("<?= $user->access ?>" == "0") {
                ...
                if ((filter_division != "" && filter_departement != "") || filter_employee != "" || filter_group != "" || filter_source != "") {
                    ...
                    toastr.info("Please Select Division, Departement, Employee, Group, or Source");

                }

            } else {

                if ((filter_division != "" && filter_departement != "" && filter_departement_sub != "") || filter_employee != "" || filter_group != "" || filter_source != "") {
                    ...
                    toastr.info("Please Select Division, Departement, Departement Sub, Employee, Group, or Source");
            ...
            if (filter_employee != "" || filter_group != "" || filter_source != "") {
                ...
                toastr.info("Please Select Employee, Group, or Source");
    ...
    $(function() {
        ...
        $("#filter_source").combobox({
            ...
            url: '<?= base_url('employee/sources/read_source') ?>',
