        ...
        <div style="width: 49%; float:left;">
            ...
            <div class="fitem">
                ...
                <select style="width:60%;" id="filter_status" panelHeight="auto" name="filter_status" class="easyui-combobox">
                    ...
                    <option value="NO ALLOWENCE">NO ALLOWENCE</option>
                </select>
            </div>
        </div>
    </fieldset>
...
<script>
    ...
    function filter() {
        ...
        $("#printout").attr('src', '<?= base_url('report/setup_allowances/print') ?>' + url);
    }
    ...
    function excel() {
        ...
        window.location.assign('<?= base_url('report/setup_allowances/print/excel') ?>' + url);
    }
