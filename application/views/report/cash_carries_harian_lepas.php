...
<script>
    ...
    function filter() {
        ...
        if (filter_from == "" || filter_to == "") {
            ...
            $('#dg').datagrid({
                ...
                url: '<?= base_url('report/cash_carries_harian_lepas/datatables') ?>' + url

            });



            $("#printout_recap").attr('src', '<?= base_url('report/cash_carries_harian_lepas/print_recap') ?>' + url);
    ...
    function pdf_view(filter_employee) {
        ...
        if (filter_from == "" || filter_to == "") {
            ...
            $("#printout").attr('src', '<?= base_url('report/cash_carries_harian_lepas/print') ?>' + url);
    ...
    function excel_detail(filter_employee) {
        ...
        if (filter_from == "" || filter_to == "") {
            ...
            window.location.assign('<?= base_url('report/cash_carries_harian_lepas/print/excel') ?>' + url);
    ...
    function excel_detail_full() {
        ...
        if (filter_from == "" || filter_to == "") {
            ...
            window.location.assign('<?= base_url('report/cash_carries_harian_lepas/print_detail/excel') ?>' + url);
    ...
    function excel() {
        ...
        if (filter_from == "" || filter_to == "") {
            ...
            window.location.assign('<?= base_url('report/cash_carries_harian_lepas/print_recap/excel') ?>' + url);
