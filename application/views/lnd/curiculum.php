...
<div id="toolbar" style="height: 200px;">
    <div style="width: 100%; padding: 10px;">
        <fieldset style="width: 50%; border:2px solid #d0d0d0; margin-bottom: 5px; margin-top: 5px; border-radius:4px;">
            ...
            <div class="fitem">
                <span style="width:35%; display:inline-block;">Curiculum ID</span>
                <input style="width:60%;" id="curiculum_id" class="easyui-combogrid">
            </div>
            <div class="fitem">
...
<div id="dlg_insert" class="easyui-dialog" title="Add New" data-options="closed: true,modal:true" style="width: 400px; padding:10px; top: 20px;">
    <form id="frm_insert" method="post" novalidate>
        <fieldset style="width:100%; border:1px solid #d0d0d0; margin-bottom: 10px; border-radius:4px; float: left;">
            ...
            <div class="fitem">
                <span style="width:35%; display:inline-block;">Score Standard</span>
                <input style="width:60%;" name="scoreStandard" required="" class="easyui-textbox">
            </div>
        </fieldset>
    </form>
</div>
