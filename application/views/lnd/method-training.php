...
<script>
    ...
    function add() {
        ...
        url_save = '<?= base_url('lnd/method_training/create_data') ?>';
        method = 'POST';
    ...
    function update() {
        ...
        if (row) {
            ...
            url_save = '<?= base_url('lnd/method_training/update_data/') ?>' + row.id;
            method = 'PUT';
        } else {
            ...
            $.messager.confirm('Warning', 'Are you sure you want to delete this data?', function(r) {
                if (r) {
                    for (var i = 0; i < rows.length; i++) {
                        var row = rows[i];
                        fetch('<?= base_url('lnd/method_training/delete_data/') ?>'+row.id, {
    ...
    $(function() {
        ...
        $('#dg').datagrid({
            url: '<?= base_url('lnd/method_training/datatables') ?>',
            columns: [[
                {field: 'ck', rowspan:'2', checkbox: true},
                {field: 'methodTrainingId', rowspan:'2', width:150, title:'Method Training ID', halign: 'center'},
                {field: 'name', rowspan:'2', width:150, title:'Name', halign: 'center'},
