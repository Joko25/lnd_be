...
<div id="toolbar" >
    <div style="width: 100%; padding: 10px;">
        ...
        <?= $button ?>
        <a href="javascript:;" style="margin-right:5px;" class="easyui-linkbutton">Training Schedule</a>
    </div>
</div>
    ...
    $(function() {
        ...
        $('#dg').datagrid({
            ...
            columns: [[
                ...
                {field: 'positionId', title:'Departement', align: 'left'},
                {field: 'description', title:'Sub Departement', align: 'left'},
                {field: 'departement_name', title:'Employee ID', align: 'left'},
                {field: 'departement_name', title:'Employee Name', align: 'left'},
                {field: 'subId', title:'Curiculum ID', align: 'left'},
                {field: 'sub_department_name', title:'Assy Name', align: 'left'},
                {field: 'desc', title:'Effective Date', align: 'left'},
                {field: 'competenceId', title:'Start Date', align: 'left'},
                {field: 'curriculumId', title:'End Date', align: 'left'},
                {field: 'desc', title:'Duration', align: 'left'},
                {field: 'desc', title:'Status', align: 'left'},
