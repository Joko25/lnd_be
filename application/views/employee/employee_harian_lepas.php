...
<script>
    ...
    function generate_id() {
        ...
        if (departement_id == "" || contract_id == "" || date_sign == "") {
            ...
            $.ajax({
                type: "post",
                url: "<?= base_url('employee/employee_harian_lepas/readNumber') ?>",
    ...
    function add() {
        ...
        url_save = '<?= base_url('employee/employee_harian_lepas/create') ?>';
    ...
    function update() {
        ...
        if (row) {
            if (row.status_check == "" || row.status_check == null) {
                ...
                url_save = '<?= base_url('employee/employee_harian_lepas/update') ?>?id=' + btoa(row.id);
            ...
            $.messager.confirm('Warning', 'Are you sure you want to delete this data?', function(r) {
                if (r) {
                    for (var i = 0; i < rows.length; i++) {
                        ...
                        $.ajax({
                            method: 'post',
                            url: '<?= base_url('employee/employee_harian_lepas/delete') ?>',
                            data: {
                                id: row.id
                            },
    ...
    function uploadData() {
        $('#frm_upload').form('submit', {
            url: '<?= base_url('employee/employee_harian_lepas/upload') ?>',
            onSubmit: function() {
                ...
                function requestData(total, json, number = 1, value = 0) {
                    if (value < 100) {
                        ...
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: "<?= base_url('employee/employee_harian_lepas/uploadCreate') ?>",
                            data: {
                                "data": json[number - 1]
                            },
                            cache: false,
    ...
    function uploadFamily() {
        $('#frm_upload').form('submit', {
            url: '<?= base_url('employee/employee_harian_lepas/uploadFamily') ?>',
            onSubmit: function() {
                if ($(this).form('validate') == false) {
                    return $(this).form('validate');
                } else {
                ...
                function requestDataFamily(total, json, number = 1, value = 0) {
                    if (value < 100) {
                        ...
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: "<?= base_url('employee/employee_harian_lepas/uploadCreateFamily') ?>",
                            data: {
                                "data": json[number - 1]
                            },
                            cache: false,
    ...
    function uploadEducation() {
        $('#frm_upload').form('submit', {
            url: '<?= base_url('employee/employee_harian_lepas/uploadEducation') ?>',
            onSubmit: function() {
                if ($(this).form('validate') == false) {
                    return $(this).form('validate');
                } else {
                ...
                function requestDataEducation(total, json, number = 1, value = 0) {
                    if (value < 100) {
                        ...
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: "<?= base_url('employee/employee_harian_lepas/uploadCreateEducation') ?>",
                            data: {
                                "data": json[number - 1]
                            },
                            cache: false,
    ...
    function uploadExperience() {
        $('#frm_upload').form('submit', {
            url: '<?= base_url('employee/employee_harian_lepas/uploadExperience') ?>',
            onSubmit: function() {
                if ($(this).form('validate') == false) {
                    return $(this).form('validate');
                } else {
                ...
                function requestDataExperience(total, json, number = 1, value = 0) {
                    if (value < 100) {
                        ...
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: "<?= base_url('employee/employee_harian_lepas/uploadCreateExperience') ?>",
                            data: {
                                "data": json[number - 1]
                            },
                            cache: false,
    ...
    function uploadTraining() {
        $('#frm_upload').form('submit', {
            url: '<?= base_url('employee/employee_harian_lepas/uploadTraining') ?>',
            onSubmit: function() {
                if ($(this).form('validate') == false) {
                    return $(this).form('validate');
                } else {
                ...
                function requestDataTraining(total, json, number = 1, value = 0) {
                    if (value < 100) {
                        ...
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: "<?= base_url('employee/employee_harian_lepas/uploadCreateTraining') ?>",
                            data: {
                                "data": json[number - 1]
                            },
                            cache: false,
    ...
    function uploadCarrer() {
        $('#frm_upload').form('submit', {
            url: '<?= base_url('employee/employee_harian_lepas/uploadCarrer') ?>',
            onSubmit: function() {
                if ($(this).form('validate') == false) {
                    return $(this).form('validate');
                } else {
                ...
                function requestDataCarrer(total, json, number = 1, value = 0) {
                    if (value < 100) {
                        ...
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: "<?= base_url('employee/employee_harian_lepas/uploadCreateCarrer') ?>",
                            data: {
                                "data": json[number - 1]
                            },
                            cache: false,
    ...
    function download_excel() {
        window.location.assign('<?= base_url('template/tmp_employee_harian_lepas.xls') ?>');
    }
    ...
    function filter() {
        ...
        $('#dg').datagrid({
            url: '<?= base_url('employee/employee_harian_lepas/datatables') ?>' + url
        });

        $("#printout").contents().find('html').html("<center><br><br><br><b style='font-size:20px;'>Please Wait...</b></center>");
        $("#printout").attr('src', '<?= base_url('employee/employee_harian_lepas/print') ?>' + url);
    }
    ...
    function excel() {
        ...
        window.location.assign('<?= base_url('employee/employee_harian_lepas/print/excel') ?>' + url);
    }
    //RELOAD
    function reload() {
    ...
    function tableFamily(number) {
        ...
        var dgFamily = $('#dgFamily').datagrid({
            url: '<?= base_url('employee/employee_harian_lepas/readFamilys/') ?>' + number,
            singleSelect: true,
            columns: [
                [{
                    field: 'id',
    ...
    function removeFamily(target) {
        ...
        $.ajax({
            method: 'post',
            url: "<?= base_url('employee/employee_harian_lepas/deleteFamily') ?>",
            data: {
                id: row.id
            },
            success: function(result) {
    ...
    function tableEducation(number) {
        ...
        var dgEducation = $('#dgEducation').datagrid({
            url: '<?= base_url('employee/employee_harian_lepas/readEducation/') ?>' + number,
            singleSelect: true,
            columns: [
                [{
                    field: 'id',
    ...
    function removeEducation() {
        ...
        $.ajax({
            method: 'post',
            url: "<?= base_url('employee/employee_harian_lepas/deleteEducation') ?>",
            data: {
                id: row.id
            },
            success: function(result) {
    ...
    function tableExperience(number) {
        ...
        var dgExperience = $('#dgExperience').datagrid({
            url: '<?= base_url('employee/employee_harian_lepas/readExperience/') ?>' + number,
            singleSelect: true,
            columns: [
                [{
                    field: 'id',
    ...
    function removeExperience() {
        ...
        $.ajax({
            method: 'post',
            url: "<?= base_url('employee/employee_harian_lepas/deleteExperience') ?>",
            data: {
                id: row.id
            },
            success: function(result) {
    ...
    function tableTraining(number) {
        ...
        var dgTraining = $('#dgTraining').datagrid({
            url: '<?= base_url('employee/employee_harian_lepas/readTraining/') ?>' + number,
            singleSelect: true,
            columns: [
                [{
                    field: 'id',
    ...
    function removeTraining() {
        ...
        $.ajax({
            method: 'post',
            url: "<?= base_url('employee/employee_harian_lepas/deleteTraining') ?>",
            data: {
                id: row.id
            },
            success: function(result) {
    ...
    function tableCarrer(number) {
        ...
        var dgCarrer = $('#dgCarrer').datagrid({
            url: '<?= base_url('employee/employee_harian_lepas/readCarrer/') ?>' + number,
            singleSelect: true,
            columns: [
                [{
                    field: 'id',
    ...
    function removeCarrer() {
        ...
        $.ajax({
            method: 'post',
            url: "<?= base_url('employee/employee_harian_lepas/deleteCarrer') ?>",
            data: {
                id: row.id
            },
            success: function(result) {
    ...
    $(function() {
        ...
        $('#dg').datagrid({
            url: '<?= base_url('employee/employee_harian_lepas/datatables') ?>',
            pagination: true,
            rownumbers: true,
                            ...
                            if (result.theme == "success") {
                                ...
                                for (let i = 0; i < totalFamily; i++) {
                                    if (rowFamily[i].name) {
                                        $.ajax({
                                            type: "post",
                                            url: '<?= base_url('employee/employee_harian_lepas/createFamily') ?>',
                                            data: {
                                                number: number,
                                                id: rowFamily[i].id,
                                ...
                                for (let i = 0; i < totalEducation; i++) {
                                    // if (rowEducation[i].level) {
                                        $.ajax({
                                            type: "post",
                                            url: '<?= base_url('employee/employee_harian_lepas/createEducation') ?>',
                                            data: {
                                                number: number,
                                ...
                                for (let i = 0; i < totalExperience; i++) {
                                    if (rowExperience[i].name) {
                                        $.ajax({
                                            type: "post",
                                            url: '<?= base_url('employee/employee_harian_lepas/createExperience') ?>',
                                            data: {
                                                number: number,
                                ...
                                for (let i = 0; i < totalTraining; i++) {
                                    if (rowTraining[i].name) {
                                        $.ajax({
                                            type: "post",
                                            url: '<?= base_url('employee/employee_harian_lepas/createTraining') ?>',
                                            data: {
                                                number: number,
                                                id: rowTraining[i].id,
                                ...
                                for (let i = 0; i < totalCarrer; i++) {
                                    if (rowCarrer[i].name) {
                                        $.ajax({
                                            type: "post",
                                            url: '<?= base_url('employee/employee_harian_lepas/createCarrer') ?>',
                                            data: {
                                                number: number,
                                                id: rowCarrer[i].id,
        ...
        $('#filter_contracts').combobox({
            url: '<?php echo base_url('employee/employee_harian_lepas/readContracts'); ?>',
            valueField: 'id',
            textField: 'name',
            prompt: 'Choose All',
            icons: [{
        ...
        $('#filter_groups').combobox({
            url: '<?php echo base_url('employee/employee_harian_lepas/readGroups'); ?>',
            valueField: 'id',
            textField: 'name',
            prompt: 'Choose All',
            icons: [{
        ...
        $('#filter_employees').combogrid({
            url: '<?= base_url('employee/employee_harian_lepas/reads') ?>',
            panelWidth: 450,
            idField: 'id',
            textField: 'name',
            mode: 'remote',
    ...
    function onChangeDate(value) {
        $.post('<?= base_url('employee/employee_harian_lepas/readService') ?>', {
    ...
    function FormatterDetail(val, row) {
        return '<a class="button-green" style="width:100%;" href="<?= base_url('employee/employee_harian_lepas/details/') ?>' + row.id + '/<?= $id_menu ?>"><i class="fa fa-user"></i></a>';
    };
    ...
    function print_employee_detail(employee_number) {
        window.open("<?= base_url('employee/employee_harian_lepas/print_employee_detail/') ?>" + window.btoa(employee_number), "_blank", "width=1200,height=600");
    }
