<!-- TABLE DATAGRID -->
<table id="dg" class="easyui-datagrid" style="width:100%; height: 600px;" data-options="rownumbers:true,singleSelect:true,url:'<?= base_url('admin/user_setting/datatables') ?>'" toolbar="#toolbar"></table>
                            ...
                            columns: [
                                [{
                                    ...
                                    formatter: function(hasil, row) {
                                        ...
                                        return '<button type="button" id="v_all' + row.id_user_set + '" onclick="' + action + '">All</button>';
                                    }
                                }, {
                                    field: 'v_view',
                                    title: 'View',
